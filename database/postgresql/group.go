...
func (g PostgresRepo) RemoveGroupRelations(groupID string) error {
	// delete all group relations
	err := g.Dbmap.Where("group_id like ?", groupID).Delete(&GroupUserRelation{}).Error
